...
def webpage_check(playwright: Playwright) -> None:
    # Before each test - verify that CSGO/Roulette/'Enter bet amount...' presented and 'Page not found' is not visible
...
def test_allcontrols_initial_check(webpage_check) -> None:
    page = webpage_check
...
def test_input_field_check(webpage_check) -> None:
    page = webpage_check
...
def test_input_controls_check(webpage_check) -> None:
    page = webpage_check
